...
public class DosenDemo {
    public static void main(String[] args) {
        ...
        Dosen d2 = new Dosen("D2", "Budi", true, 25);
        ...
        Dosen d7 = new Dosen("D7", "cici", false, 30);
        ...
        // int count = list.jumlahPencarianDataSequential10(cari);
        // int pos[] = list.pencarianDataSequential10(count, cari);
        int pos = list.pencarianDataSequential10(cari);
        list.tampilPosisi(cari, pos);
        System.out.println("------------------------");

        // System.out.println("Data dosen setelah sorting berdasarkan usia menggunakan
        // bubble sort ASC:");
        // list.sortingASC();
        // list.tampil();
